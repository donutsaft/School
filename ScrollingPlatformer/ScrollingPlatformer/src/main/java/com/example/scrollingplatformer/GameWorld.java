...
class GameWorld {
    ...
    public Scene createScene() {
        ...
        Image bgImage = new Image(getClass().getResourceAsStream("/backgrounds/bg_placeholder.png"));
...
//        platforms.add(new Platform(0, HEIGHT - 150, 1000, 50, Color.BROWN));
        ...
        platforms.add(new Platform(-10, HEIGHT - 500, 10, 500, Color.TRANSPARENT));//Unsichtbare Barriere
